...
const CASTING_TIMES = [
  'Action', 'Bonus Action', 'Reaction', '1 Minute', '10 Minutes', '1 Hour', '8 Hours', '12 Hours', '24 Hours',
] as const;
...
const DURATIONS = [
  '1 Hour', '1 Minute', '1 Round', '10 Minutes', '24 Hours', '8 Hours', 'Instantaneous', 'Until Dispelled',
] as const;
